  ...
  return (
    <footer className="w-full bg-[#D4C8BE] text-[#5C4B3D] pt-[60px] pb-[30px] font-sans">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2">
        ...
        <a href={whatsappFloatUrl} target="_blank" rel="noopener noreferrer" className="w-[50px] h-[50px] bg-[#25D366] rounded-full flex items-center justify-center shadow-lg cursor-pointer">
