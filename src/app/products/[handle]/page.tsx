        ...
        <div className="container px-4 md:px-8 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="flex flex-col">
              ...
              {/* Delivery Estimate */}
              <div className="mt-4 bg-[#F5F2ED] rounded-lg p-4 flex items-start gap-3">
                <Truck size={18} className="text-[#5C4B3D] flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-[13px] font-medium text-[#1A1A1A]">Ships within 24–48 hours</p>
                  <p className="text-[12px] text-[#757575] mt-0.5">Estimated Delivery: 3–7 Business Days across India</p>
                </div>
              </div>
              ...
              >
                ...
                Need help choosing a color? Chat on WhatsApp
              </a>

              {/* Trust Section */}
              <div className="mt-4 grid grid-cols-2 gap-2">
                {[
                  { icon: <Shield size={14} className="text-[#5C4B3D]" />, text: "Secure Payments" },
                  { icon: <Truck size={14} className="text-[#5C4B3D]" />, text: "Fast Shipping" },
                  { icon: <Check size={14} className="text-[#5C4B3D]" />, text: "Quality Checked" },
                  { icon: <RotateCcw size={14} className="text-[#5C4B3D]" />, text: "Easy Returns" },
                ].map((item, i) => (
              ...
              <div className="border-b border-[#E8E4DE]">
                <button
                  ...
                  className="w-full flex items-center justify-between py-4 text-left"
                >
                  <span className="text-[14px] font-medium text-[#1A1A1A] uppercase tracking-wider">Customer Questions</span>
                  <ChevronDown size={18} className={`text-[#757575] transition-transform duration-300 ${openAccordion === "faq" ? "rotate-180" : ""}`} />
                </button>
                <div className={`overflow-hidden transition-all duration-300 ${openAccordion === "faq" ? "max-h-[800px] pb-4" : "max-h-0"}`}>
                  <div className="space-y-4">
                    {[
                      { q: "Will this slip?", a: "Our hijabs are designed with anti-slip fabric. We also recommend our magnetic pins or undercaps for extra grip throughout the day." },
                      { q: "Is it breathable?", a: "Yes! We use lightweight, breathable fabrics suited for Indian weather — comfortable for both daily wear and special occasions." },
                      { q: "Is it suitable for daily wear?", a: "Absolutely. Our hijabs are crafted for everyday elegance — soft enough for comfort, durable enough for daily styling." },
                      { q: "Can I exchange colors?", a: "Yes, we offer easy exchanges. Contact us on WhatsApp within 7 days of delivery and we'll help you sort it out quickly." },
                      { q: "How long is delivery?", a: "We ship within 24–48 hours of order placement. Delivery takes 3–7 business days across India depending on your location." },
                    ].map((faq, i) => (
                      <div key={i} className="border-b border-[#F5F2ED] last:border-0 pb-3 last:pb-0">
                        <p className="text-[13px] font-semibold text-[#1A1A1A] mb-1.5">Q: {faq.q}</p>
                        <p className="text-[13px] text-[#555] leading-relaxed">A: {faq.a}</p>
                      </div>
                    ))}
                  </div>
                </div>
