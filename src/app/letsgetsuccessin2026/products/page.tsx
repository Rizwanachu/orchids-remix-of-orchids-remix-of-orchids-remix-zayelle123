  ...
  const handleDuplicate = async (product: Product) => {
    ...
    try {
      ...
      const productData = {
        ...
        image: product.image,
        hoverImage: p.hoverImage || product.image,
        badge: product.badge || undefined,
        description: p.description || "",
        details: Array.isArray(p.details) ? p.details : (p.details ? [p.details] : []),
        ...
        shippingCost: p.shippingCost ?? 49,
        shippingCostKerala: p.shippingCostKerala ?? 49,
        isFreeShipping: p.isFreeShipping ?? false,
        colors: Array.isArray(p.colors) ? p.colors : [],
        colorSwatchStyle: p.colorSwatchStyle || "pills",
        sizes: Array.isArray(p.sizes) ? p.sizes : [],
        bundlePricing: Array.isArray(p.bundlePricing) ? p.bundlePricing : [],
        deliveryCharges: p.deliveryCharges ?? null,
